...
STORE_PATH = os.environ.get("ROOM_STORE_PATH", "rooms_state.json")

def save_rooms():
    try:
        with open(STORE_PATH, "w", encoding="utf-8") as f:
            json.dump(_plain(rooms), f)
    except Exception:
        pass
